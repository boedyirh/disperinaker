<div>
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                @foreach ($dataPreview as $index => $dataItem)
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {{ wordwrap($dataItem['nomer_hp'],4,' ',true)}}
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                @foreach ($fotoPreview as $index => $dataItem)
                    <div class="col-sm-6">
                        <label class="imagecontainer">
                            Foto KTP
                        </label>
                        <div class="imagecontainer">
                            <img src="{{ url('storage/foto_ktp/'.$dataItem['foto_ktp']) }}" width="300" height="200" class="border" alt="Logo">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <label class="imagecontainer">
                        ...
                        <div class="imagecontainer">
                            <img src="{{ url('storage/foto_diri/'.$dataItem['foto_diri']) }}" width="150" height="200" class="border" alt="Logo">
                        </div>
                    </div>
                @endforeach
            </div>
