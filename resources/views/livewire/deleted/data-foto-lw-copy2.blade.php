    ...
    <form  method="POST" enctype="multipart/form-data" wire:submit.prevent="submit">
                        ...
                        <div class="" x-data="imageData1()">
                            ...
                            <div  class="imagecontainer"  x-show="previewUrl !== ''" >
                                ...
                                <div class="row inputcenter">
                                    <br>
                                    @if ($cek_foto)
                                        <input type="hidden" name="thumbnail1" id="thumbnail1"      wire:model="foto_ktp"  style="width: 300px;" @change="updatePreview1()">
                                    @else
                                        <input type="file" name="thumbnail1" id="thumbnail1"      wire:model="foto_ktp"  style="width: 300px;" @change="updatePreview1()">
                                    @endif
                        ...
                        <div class="" x-data="imageData2()">
                            ...
                            <div  class="imagecontainer" x-show="previewUrl !== ''" >
                                ...
                                <div class="row inputcenter">
                                    <br>
                                    @if ($cek_foto)
                                        <input type="hidden" name="thumbnail2" id="thumbnail2"       wire:model="foto_diri"  style="width: 300px;" @change="updatePreview2()">
                                    @else
                                        <input type="file" name="thumbnail2" id="thumbnail2"       wire:model="foto_diri"  style="width: 300px;" @change="updatePreview2()">
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                @if ($cek_foto)
                    <input type="hidden" name="posisi" value="gantifoto">
                    <input type="submit" class="btn-sm tambah-button" name="action" value="Ganti Foto">
