...
class DropdownModel extends Model
{
    ...
    public function getTingkatPendidikan($tingkat_pendidikan_id)
    {
        ...
        return DropdownModel::where('dropdown_type','tingkat_pendidikan')->where('value_dropdown',$tingkat_pendidikan_id)->first();
    }
    ...
    public function getJenisPelatihan($jenis_pelatihan_id)
    {
        ...
        // ->first();
        // return $nama_tingkat;
        return DropdownModel::where('dropdown_type','jenis_pelatihan')->where('value_dropdown',$jenis_pelatihan_id)->first();
    ...
    public function getBidangUsaha($bidang_usaha_id)
    {
        ...
        // ->first();
        // return $nama_tingkat;
        return DropdownModel::where('dropdown_type','bidang_usaha')->where('value_dropdown',$bidang_usaha_id)->first();
